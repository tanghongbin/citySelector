...
public class CustomWheelView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int modeWidthSize = MeasureSpec.getSize(widthMeasureSpec);
        controlWidth = modeWidthSize;
    ...
    private synchronized void slowMove(final int move) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (final ItemObject item : itemList) {
                    if (item.isSelected()) {
                        if (onSelectListener != null)
    ...
    private void drawLine(Canvas canvas) {
        ...
        float lineStart = controlWidth / 2 - splitLineWidth / 2;
        float lineEnd = controlWidth / 2 + splitLineWidth / 2;
        canvas.drawLine(lineStart, controlHeight / 2 - unitHeight / 2 + 2,
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        unitHeight = (int) attribute.getDimension(
                R.styleable.CustomWheelView_unitHight, 32);
        ...
        normalColor = attribute.getColor(
                R.styleable.CustomWheelView_normalTextColor, 0xff000000);
        selectedColor = attribute.getColor(
                R.styleable.CustomWheelView_selectedTextColor, 0xffff0000);
        lineColor = attribute.getColor(R.styleable.CustomWheelView_lineColor,
                0xff000000);
        lineWidth = attribute.getDimension(R.styleable.CustomWheelView_lineHeight, 2f);
        maskHight = attribute.getDimension(R.styleable.CustomWheelView_maskHight,
                48.0f);
        ...
        splitLineWidth = attribute.getDimension(R.styleable.CustomWheelView_splitLineWidth,
                100f);
